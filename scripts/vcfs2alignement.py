...
def get_argv() :
    ...
    parser.add_argument("-nom_a_suppr", default="_snip", type=str, help='name at the end of snippy folder')
    parser.add_argument("--only_snp", action='store_true',help='if yes, only SNP. Dont put as false, indel were not tested')
